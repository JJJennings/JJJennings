    ...
    <section id="achievements" className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">Driving excellence in oncology clinical development and regulatory science</p>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          {achievements.map((achievement, index) => (
            <div key={index} className="group">
              <div className="bg-card border rounded-xl p-8 hover:shadow-xl transition-all duration-300 hover:border-teal-200">
